...
# escalation rule and --yes ban, plus the comment/docs accident-test rule the
# scout scaffold omits for a report-only deliverable. The instructions also carry `# Task` with
